...
class Constans {
  ...
  static const List<Color> kColors = [
    ...
    Color(0xff1DE9B6), // Aquamarine
    Color(0xff76FF03), // Bright Green
    Color(0xffD500F9), // Electric Purple
    Color(0xffFF1744), // Vivid Red
    Color(0xff00E5FF), // Cyan
    Color(0xff651FFF), // Vivid Violet
    Color(0xffFFD740), // Bright Yellow
    Color(0xffC6FF00), // Lime Bright
    Color(0xff00C853), // Strong Green
    Color(0xff1B5E20), // Dark Green
    Color(0xffB71C1C), // Dark Red
    Color(0xff4A148C), // Dark Purple
    Color(0xff880E4F), // Raspberry
